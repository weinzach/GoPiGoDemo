...
module.exports = function (_Configurable) {
    ...
    function Publisher(advertisement, discoveryOptions) {
        ...
        _this.advertisement.axon_type = 'pub-emitter';
        ...
        var onPort = function onPort(err, port) {
            ...
            _this.sock = new axon.PubEmitterSocket();
            _this.sock.sock.bind(port);
            _this.sock.sock.server.on('error', function (err) {
                if (err.code != 'EADDRINUSE') throw err;

                portfinder.getPort({ host: host, port: _this.advertisement.port }, onPort);
            });

            _this.sock.sock.on('bind', function (_) {
