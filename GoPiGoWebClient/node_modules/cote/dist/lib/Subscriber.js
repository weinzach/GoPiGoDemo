...
module.exports = function (_Monitorable) {
    ...
    function Subscriber(advertisement, discoveryOptions) {
        ...
        _this._on('added', function (obj) {
            ...
            obj.sock.sock.on('connect', function (_) {
                _this.emit(_this.formatTypeWithNamespace('connect'), obj);
            });

            obj.sock.sock.set('retry timeout', 0);

            obj.sock.sock.on('socket close', function (_) {
    ...
    _createClass(Subscriber, [{
        ...
        value: function _on(type, listener) {
            return _get(Subscriber.prototype.__proto__ || Object.getPrototypeOf(Subscriber.prototype), 'on', this).call(this, type, listener);
        }
    }, {
